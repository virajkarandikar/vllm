...
async def run_request(
    ...
    """
    Sends a single FastConformer-style streaming request using input embeddings
    and records TTFT, inter-step latencies, and total request latency.
    """
    ...
    try:
        first_packet = torch.randn(1, input_embed_dim, dtype=torch.bfloat16)
        ...
        for i in range(1, steps):
            pkt = torch.randn(1, input_embed_dim, dtype=torch.bfloat16)
